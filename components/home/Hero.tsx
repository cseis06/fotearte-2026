...
const Hero = () => {
  return (
    <section className="relative h-auto w-full">
      ...
      />
      <div className="relative z-10 flex flex-col items-center justify-center text-center h-[115dvh]">
        <h1 
        ...
        <span 
          className='text-base tracking-[0.3em] font-light text-orange-600'
